...
public class MySqlExplorer : Explorer
{
    #region Constants
    ...
    public MySqlExplorer()
    {
    }

    public MySqlExplorer(MySqlConnection connection)
        : base(connection)
    {
    }
    ...
    protected int GetTableObjectId(string schemaName, string tableName)
    {
        ...
        using var command = (MySqlCommand)this.Connection.CreateCommand();
        command.CommandText =
            @"
SELECT
    T.object_id
...
";
    ...
    private MySqlConnection GetOpenSqlConnection()
    {
    ...
    protected override IReadOnlyList<string> GetTableNamesImpl(string schemaName)
    {
        ...
        var connection = (MySqlConnection)this.GetOpenConnection();
        using var command = connection.CreateCommand();
